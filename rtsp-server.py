...
def getPipeline(device, height, width, bitrate, format, rotation, framerate):
    ...
    if device == "rpicam":
            ...
            s_src = "rpicamsrc bitrate={0} rotation={3} preview=false ! video/x-h264,profile=(string)main,quantisation-parameter=0,width={1},height={2}{4}".format(bitrate*1000, width, height, devrotation, framestr)
